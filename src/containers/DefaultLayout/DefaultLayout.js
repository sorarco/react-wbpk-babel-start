        ...
        <AppHeader fixed>
          ...
          <Nav className="ml-auto" navbar>
            <NavItem className="d-md-down-none">
              <NavLink href="#">
                <i className="cui-bell icons font-xl d-block" />
            ...
            <NavItem className="d-md-down-none">
              <NavLink href="#">
                <i className="cui-list icons icons font-xl d-block" />
              </NavLink>
            </NavItem>
            <NavItem className="d-md-down-none">
              <NavLink href="#">
                <i className="cui-location-pin icons icons font-xl d-block" />
              </NavLink>
            </NavItem>
            <AppHeaderDropdown>
              <DropdownToggle nav>
